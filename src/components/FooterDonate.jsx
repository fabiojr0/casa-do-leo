...
function FooterDonate() {
  return (
    <div className="relative w-screen flex flex-col items-center justify-center gap-2 pb-4 mt-4 final-mobile2:gap-4 lg:gap-4 lg:py-10">
      ...
      <h4 className="text-verde text-sm font-semibold sm:text-lg lg:text-2xl final-mobile:text-base">
        Sua doação pode fazer a diferença
      </h4>
      <p className="text-[0.7rem] text-center w-3/4 sm:text-base lg:text-xl final-mobile:text-xs">
