...
function AboutUs() {
  return (
    <div className="flex gap-4 p-2 px-3 justify-between items-center max-md:my-5 w-full lg:p-8 lg:pt-16 lg:flex-row flex-col-reverse" id="quem-somos">
      <img
        src="quemsomos.jpg"
      ...
      <section className="w-full flex flex-col mobile425:gap-2 final-mobile:gap-4 max-sm:gap-1 lg:gap-5 lg:w-1/2 ">
        ...
        <p className="text-xs final-mobile:text-xs final-mobile2:text-sm sm:text-lg lg:text-xl xl:text-2xl">
