      ...
      <button
        className={
          cancel
            ...
            : "bg-verde px-2 py-1 text-white rounded text-xs hover:bg-green-700 transition-all flex items-center sm:text-lg active:translate-y-1 final-mobile:text-sm disabled:bg-green-800 xl:text-2xl"
        }
        onClick={() => click()}
        type="submit"
        disabled={disabled}
